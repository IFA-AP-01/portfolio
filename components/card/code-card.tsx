...
export default function CodeCard() {
  ...
  return (
    <div className="w-full overflow-hidden bg-[#1e1e1e] neo-shadow border-2 border-black">
      {/* Window Header */}
      <div className="w-full flex items-center justify-between bg-[#f0f0f0] dark:bg-[#252526] px-2 sm:px-4 py-2 sm:py-3 border-b-2 border-black">
              ...
              <div className="flex-1 min-w-0 break-all whitespace-pre-wrap font-semibold">
                {line.hasContent ? (
                  <Fragment>
                    ...
                    />
                    {line.isCurrent && displayedCode.length < CODE.length && (
      ...
      {/* Status Bar */}
      <div className="w-full flex items-center justify-between bg-[#E9945B] px-2 sm:px-4 py-1 sm:py-2 text-[9px] sm:text-xs font-mono text-black font-bold uppercase tracking-wider">
